    ...
    <div class="home_page">
        <div class="gray_bar">
            <div id="mobile_search"  class="col-xs-10">
                ...
                <!--</form>-->
                <input v-model="mobile_search_box" placeholder="Search All Path Stores" >
            </div>
        ...
        <div class="menu_btn_holder">
            ...
            <router-link tag="li" to="/" active-class="active" class="all_caps menu_btn" exact>
                <a class="all_caps menu_btn_label">Home</a>
            </router-link>
