<template>
    <div class="stores_page">
        <div class="all_caps store_header">
            {{$t("message.storesDirectory")}}
        </div>
        <h4 class="all_caps home_title"> {{$t("message.discoverPath")}}</h4>
        <div class="store_cat_listing">
            <div class="all_caps cat_title" id="dine" @click="show_dine = !show_dine">
                {{$t("message.dine")}}
            ...
            <div class="all_caps cat_title" id="shop" @click="show_shop = !show_shop">
                {{$t("message.shop")}}
                <img src="//codecloud.cdn.speedyrails.net/sites/59515e256e6f646e860c0000/image/png/1498596224000/up_arrow_2x.png" class="up_arrow pull-right " alt="" v-show="show_shop">
            </div>
            <hr>
            ...
            <div class="all_caps cat_title" id="service" @click="show_service = !show_service">
                {{$t("message.service")}}
            ...
            <div class="all_caps cat_title" id="stay" @click="show_stay = !show_stay">
                {{$t("message.stay")}}
