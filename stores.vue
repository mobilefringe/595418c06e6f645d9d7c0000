    ...
    return Vue.component("stores-component", {
      ...
      methods: {
        ...
        getStoreByCategory() {
            ...
            var shop_cats = ["Apparel","Accessories", "Accessories & Luggage", "Beauty Product","Bedding","Cards & Stationary","Cards, Stationary and Gifts","Children's Apparel", "Children's Wear", "Drugstore","Electronics","Electronics, Computers and Telephones", "Electronics, Computers, and Telephones","Fashion","Fashion & Accessories", "Fashion Accessories","Flower","Flowers", "Footwear", "General Variety","Groceries","Grocery Store","Health & Beauty","Healthy Choices","Jewelery & Accessories"," Jewellery","Jewellery","Kids & Ladies Apparel","Kids Apparel","Ladies Apparel","Leather & Luggage","Leather and Luggage","Market Place"];
            var play_cats = ["ATTRACTIONS","Art Gallery","Lounge"];
            var stay_cats = ["Hotel","Lounge"];
            var service_cats = ["Automotive","Banking and Financial Services","Beauty Salon","Business Services","Dental","Dry Cleaning Services","Dry Clearers","Education","Eyewear","Eyewear and Health Services","Food Exchange","Food Services","Groceries","General Variety","Hair Salon","Health","Health & Wellness","Health Services","Management"];
            console.log(cats);
            var temp_dine_array = [];
            var temp_shop_array = [];
