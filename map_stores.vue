<template>
    <div class="maps">
        <div class="map_page">
            ...
            <!--</div>-->
            <svg-map @updateMap="updateSVGMap()"></svg-map>
        </div>
...
<script>
  define(["Vue", "jquery", "Raphael", "mm_mapsvg","mousewheel","vue!search-component"], function(Vue, $,Raphael,mapsvg,mousewheel) {
