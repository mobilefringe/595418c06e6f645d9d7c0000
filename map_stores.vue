    ...
    <div class="maps">
        ...
        <div class="blue_dets_box" v-for="store in all_stores">
            ...
            <div class="more_dets pull-right">
                <router-link v-bind:to="concatVal('stores/',store.slug)"><img src="//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1499180555000/Right Arrow.png" class="" alt=""></router-link>
            </div>
