        ...
        <div class="map_page">
            <div class="map">
                ...
                <div class="demo_1 map3" style="" id="mapsvg">       
                    ...
                    <div v-for = "store in all_stores" style="display: inline-block;" :id="concatVal('store_',store.id)" :data-coords="concatCood(store.x_coordinate, store.y_coordinate)">
                       
                            <a class="marker"  :data-coords="concatCood(store.x_coordinate, store.y_coordinate)" style="color:#fff" :href="concatVal('/stores/',store.slug)">  {{store.name}}  </a>
