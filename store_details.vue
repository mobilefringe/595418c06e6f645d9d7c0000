<template>
    <div >
        ...
        <div class="blue_box"  v-if="currentStore">
            ...
            <p class="dets_data">
                {{currentStore.property_id}} - {{currentStore.store_hours_today.open_time | moment("h a z", timezone)}}  {{currentStore.store_hours_today.close_time | moment("h a", timezone)}}
            </p>
        </div>
        <!-- Store Details -->
        ...
        watch: {
            ...
            all_hours : function () {
                ...
                _.forEach(this.currentStore.store_hours, function(val, key) {
                    ...
                    console.log(open_time.tz(this.timezone));
                    var close_time = moment(hours[0].close_time).format("h a");
