    ...
    <div id="store_details">
        ...
        <div class="blue_box"  v-if="currentStore">
            ...
            <p class="dets_data">
                ...
                <span v-if='currentStore.todays_hour != ""'> - {{currentStore.store_hours_today.open_time | moment("h a ", timezone)}}  {{currentStore.store_hours_today.close_time | moment("h a z", timezone)}}</span>
            </p>
        </div>
        <!-- Store Details -->
