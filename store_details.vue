  ...
  <!--<div class="row" v-if="currentStore">-->
    ...
    <div >
        ...
        <div class="blue_dets_box"  v-if="currentStore">
            ...
            <p class="dets_data">{{currentStore.store_hours_data.open_time | moment("MMM D", timezone)}} - {{currentStore.store_hours_data.close_time | moment("MMM D", timezone)}}</p>
...
<script>
  define(["Vue", "jquery", "mm_mapsvg","mousewheel","raphael", "moment", "moment-timezone", "vue-moment"], function(Vue, $,mapsvg,mousewheel,raphael) {
