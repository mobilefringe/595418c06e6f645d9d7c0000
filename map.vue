<template>
    <div>
        <div class="map_page">
            <div class="gray_bar">
                <div class="col-xs-10">
                    <input v-model="mobile_search_store" v-on:keyup.enter="showStore1Details" class= "mobile_map_search" placeholder="Search Stores" >
            ...
            <div class="map">
                ...
                <div class="blue_dets_box hidden_now">
                    <img @click="removeSearch1" src="//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1499180586000/Close_button.png" class="search_icon" alt=""> 
                    {{mobile_search_store}}
                    <img @click="viewMoreDets1" src="//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1499180555000/Right Arrow.png" class="search_icon" alt="">
                </div>
                <div class="green_dets_box hidden_now">
                    <img @click="removeSearch2" src="//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1499180586000/Close_button.png" class="search_icon" alt="">
                    {{mobile_find_store}}
