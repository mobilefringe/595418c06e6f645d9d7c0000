        ...
        <div class="position_relative map_search_page">
            ...
            <div class="map">
                ...
                <div v-if = "store1" class="blue_dets_box">
                    ...
                    <p class="dets_data">{{store1.property_id}} {{mobile_search_store}}</p>
                </div>
        ...
        computed: {
         ...
         methods: {
            swapSearchTerm: function () {
                ...
                console.log($(".search1 .input").html(this.store1.name));
                console.log($(".search2 .input").html(this.store2.name));
