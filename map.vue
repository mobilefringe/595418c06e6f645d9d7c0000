    ...
    return Vue.component("map-component", {
        ...
        watch: {
            store1 : function () {
                ...
                var mark = this.svgMapRef.addMarker(this.store1,'//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1500567644000/map_pin_1x.png')[0];
            ...
            store2 : function () {
                 var mark = this.svgMapRef.addMarker(this.store2,'//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1501693321000/map_pin_green_1x.png')[0];
        ...
        computed: {
         ...
         methods: {
            ...
            removeSearch2 :function() {
                // $(".search2 .input").val('');
                this.svgMapRef.removeMark (this.store2.marker);
                this.search2 = "";
                this.store2 = null;
            },
