        ...
        <div class="position_relative map_search_page">
            <div class="gray_bar">
                <div class="col-xs-10">
                    ...
                    <search-component :list="allStores" :suggestion-attribute="suggestionAttribute" @select="onOptionSelect2" class="search2" placeholder="Find a store near you" v-model="search2">
                        <template slot="item" scope="option">
                            <article class="media ">
                                <p>
                                    <strong>{{ option.data.name }} @ {{option.data.property_id}}</strong>
