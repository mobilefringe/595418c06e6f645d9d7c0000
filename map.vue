                ...
                <div class="demo_1 map3" style="">       
                    ...
                    <div class="blue_dets_box hidden_now">
                        ...
                        <div class="more_dets pull-right">
                            <router-link to="home"><img @click="viewMoreDets1" src="//codecloud.cdn.speedyrails.net/sites/595418c06e6f645d9d7c0000/image/png/1499180555000/Right Arrow.png" class="" alt=""></router-link>
                        </div>
                        <p class="dets_title">{{store1_name}} </p>
                    ...
                    <div class="green_dets_box hidden_now">
                        ...
                        <p class="dets_title">{{store2_name}}</p>
