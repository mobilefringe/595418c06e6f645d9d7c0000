<template>
    <div>
        <div class="position_relative map_search_page">
            <div class="gray_bar">
                <div class="col-xs-10">
                    <search-component :list="allStores" :suggestion-attribute="suggestionAttribute" @select="onOptionSelect1" class="search1" placeholder="Search Stores" v-model="input1">
        ...
        computed: {
         ...
         methods: {
            ...
            onOptionSelect2(option) {
                if(this.search_two === $('.search2').offset()) {
                    this.store2 = option;
                }
                else {
                    this.store1 = option;
